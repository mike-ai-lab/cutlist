...
require File.join(File.dirname(__FILE__), 'jwa/signing_algorithm')
require File.join(File.dirname(__FILE__), 'jwa/ecdsa')
require File.join(File.dirname(__FILE__), 'jwa/hmac')
require File.join(File.dirname(__FILE__), 'jwa/none')
require File.join(File.dirname(__FILE__), 'jwa/ps')
require File.join(File.dirname(__FILE__), 'jwa/rsa')
require File.join(File.dirname(__FILE__), 'jwa/unsupported')
