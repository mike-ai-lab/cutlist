  ...
  module TrialManager
    ...
    class << self
      ...
      def get_trial_days_remaining
        ...
        begin
          jwt_token = File.read(LicenseManager::LICENSE_FILE_PATH).strip
      ...
      def show_trial_status
        # Check server for most up-to-date trial status
        if defined?(AutoNestCut::LicenseManager)
          AutoNestCut::LicenseManager.check_existing_trial
        end
